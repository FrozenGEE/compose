# 【更新日志-2025-09-10】
- NS2真好玩
- 新增MP-V2数据库版，单独部署的已新增，修正openlist部分问题
- media-aio那些模板已经修改为 MP数据库版，响应速度快不少，推荐，模板为全新部署，非原有数据库迁移
- unRAID 的 MP-v2数据库带迁移模板，还存在问题未解决，其余模板都写好，由于没有威联通/铁威马/万由这些设备，故没测试，应该都没问题
- dpanel统一改为使用lite精简版
